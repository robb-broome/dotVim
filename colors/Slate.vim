" Vim color file
" Converted from Textmate theme Slate using Coloration v0.2.2 (http://github.com/sickill/coloration)
...
hi Visual  guifg=NONE guibg=#708c99 gui=NONE
hi CursorLine  guifg=NONE guibg=#132834 gui=NONE
hi CursorColumn  guifg=NONE guibg=#132834 gui=NONE
hi LineNr  guifg=#8a98a1 guibg=#1b3849 gui=NONE
hi VertSplit  guifg=#455c6a guibg=#455c6a gui=NONE
hi MatchParen  guifg=#ffaa00 guibg=NONE gui=NONE
hi StatusLine  guifg=#f8f8f8 guibg=#455c6a gui=bold
hi StatusLineNC  guifg=#f8f8f8 guibg=#455c6a gui=NONE
hi Pmenu  guifg=#efe900 guibg=NONE gui=NONE
hi PmenuSel  guifg=NONE guibg=#708c99 gui=NONE
hi IncSearch  guifg=NONE guibg=#65584a gui=NONE
hi Search  guifg=NONE guibg=#65584a gui=NONE
hi Directory  guifg=#ff3a83 guibg=NONE gui=NONE
hi Folded  guifg=#1e9ae0 guibg=#1b3849 gui=NONE

hi Normal  guifg=#f8f8f8 guibg=#1b3849 gui=NONE
...
hi ErrorMsg  guifg=#f8f8f8 guibg=#a72d1d gui=NONE
hi WarningMsg  guifg=#f8f8f8 guibg=#a72d1d gui=NONE
...
hi NonText  guifg=#546a77 guibg=#132834 gui=NONE
...
hi SpecialKey  guifg=#546a77 guibg=#132834 gui=NONE
